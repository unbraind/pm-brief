...
- Certify pm CLI 2026.9.23 and adopt the guarded pm-ops merge-driver launcher ([pm-brief-ewrg](https://github.com/unbraind/pm-brief/blob/main/.agents/pm/chores/pm-brief-ewrg.toon))

## 2026.9.22 - 2026-09-22

### Fixed

- A publish that npm accepts late is reported as failed and the GitHub Release is skipped on bun mirror lag ([pm-brief-nkx1](https://github.com/unbraind/pm-brief/blob/main/.agents/pm/issues/pm-brief-nkx1.toon))

### Other

- Certify pm CLI 2026.9.21 and install merge drivers through the canonical pm-ops launcher ([pm-brief-hw3t](https://github.com/unbraind/pm-brief/blob/main/.agents/pm/tasks/pm-brief-hw3t.toon))
